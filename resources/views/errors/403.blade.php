...
<head>
    ...
    <title>403 - Access Denied | {{ config('app.name', 'EggFlow') }}</title>
...
<body class="min-h-screen bg-gradient-to-br from-amber-50 via-orange-50 to-yellow-50 dark:from-gray-900 dark:via-gray-900 dark:to-gray-800 antialiased">
    ...
    <div class="relative flex min-h-screen flex-col items-center justify-center p-4">
        <div class="w-full max-w-md text-center">
            <!-- Icon -->
            <div class="mx-auto mb-6 flex h-24 w-24 items-center justify-center rounded-full bg-red-100 dark:bg-red-900/30">
            ...
            <!-- Title -->
            <h2 class="mb-4 text-2xl font-semibold text-gray-800 dark:text-gray-200">Access Denied</h2>
